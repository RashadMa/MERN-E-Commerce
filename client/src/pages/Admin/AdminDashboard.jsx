                        ...
                        <div className="">
                              <div className="w-[80%] flex justify-around flex-wrap mx-auto">
                                    <div className="rounded-lg p-5 w-[20rem] mt-5 bg-gray-600">
                                          ...
                                          <h1 className="text-xl font-bold text-white">$ {isLoading ? <Loader /> : sales.totalSales.toFixed(2)}</h1>
                                    </div>
                                    <div className="rounded-lg  p-5 w-[20rem] mt-5 bg-gray-600">
                                          <div className="font-bold rounded-full w-[3rem] bg-gray-100 text-center p-3">$</div>
                                    ...
                                    <div className="rounded-lg  p-5 w-[20rem] mt-5 bg-gray-600">
                                          ...
                                          <h1 className="text-xl font-bold text-white">$ {isLoading ? <Loader /> : orders?.totalOrders}</h1>
                                    </div>
                              </div>
